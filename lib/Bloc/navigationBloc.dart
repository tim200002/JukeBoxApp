...
class NavigateToNowPlayingScreen extends NavigationEvents{
  ...
  final bool isAdmin;
  NavigateToNowPlayingScreen({@required this.isAdmin, @required this.partyId, @required this.partyName});
}
...
class StateNowPlayingScreen extends NavigationStates{
  ...
  final bool isAdmin;
  final String userId;
  StateNowPlayingScreen({@required this.isAdmin, @required this.partyId, @required this.partyName, @required this.userId});
}
...
class NavigationBloc extends Bloc<NavigationEvents, NavigationStates>{
  ...
  Stream<NavigationStates> mapEventToState(NavigationEvents event) async*{
    if(event is NavigateToWelcomeScreen){
      ...
      yield StateNowPlayingScreen(partyId: event.partyId, isAdmin: event.isAdmin, partyName: event.partyName, userId: userId);
    }
